...
<div class="wrap5">
	<div class="retweet-popup-body-wrap">
		<div class="retweet-popup-heading">
			<h3>Chia sẻ lên trang cá nhân?</h3>
			<span><button class="close-retweet-popup"><i class="fa fa-times" aria-hidden="true"></i></button></span>
		</div>
		<div class="retweet-popup-input">
			<div class="retweet-popup-input-inner">
				<input class="retweetMsg" type="text" placeholder="Thêm bình luận của bạn"/>
			</div>
		</div>
		...
		<div class="retweet-popup-footer"> 
			<div class="retweet-popup-footer-right">
				<button class="retweet-it" data-tweet="<?php echo $tweet->tweetID;?>" data-user="<?php echo $tweet->user_id;?>" type="submit"><i class="fa fa-retweet" aria-hidden="true"></i>Đăng</button>
			</div>
		</div>
	</div>
</div>
