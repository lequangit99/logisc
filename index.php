        ...
        <div class="inner-wrapper">
            ...
            <div class="main-container">
                ...
                <div class="content-left">
                    ...
                    <br />
                    <p>A place to connect with your friends — and Get updates from the people you love, And get the
                        updates from the world and things that interest you.</p>
                ...
                <div class="content-right">
                    ...
                    <div class="signup-wrapper">
                        <?php include 'includes/signup-frm.php'  ?>
                    </div>
                    <!-- SIGN UP wrapper end -->
