...
<head>
    <title>Proifle - Page - Tweety</title>
    <meta charset="UTF-8" />
        ...
        <div class="header-wrapper">
            <div class="nav-container">
                <div class="nav">
                    <div class="nav-left">
                        <ul>
                            <li><a href="<?php echo BASE_URL; ?>home.php"><i class="fa fa-home"
                                        aria-hidden="true"></i>Home</a></li>
                            <?php if($getFromU->loggedIn() === true){ ?>
                            <li><a href="<?php echo BASE_URL; ?>i/notifications"><i class="fa fa-bell"
                                        aria-hidden="true"></i>Notification</a></li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo BASE_URL.$profileData->username; ?>/following">
                                ...
                                <div class="n-bottom">
                                    <span class="count-following">0</span>
                                </div>
                            </a>
                        </li>
                        <li>
                            ...
                            <div class="profile-info-inner">
                                ...
                                <div class="profile-name-wrap">
                                    <div class="profile-name">
                                        <a
                                            href="<?php echo BASE_URL.$profileData->username; ?>"><?php echo $profileData->screenName; ?></a>
                                    </div>
                                    ...
                                    <div class="profile-extra-inner">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="profile-ex-location">
                                                    <a href="<?php echo $profileData->website; ?>"
                                                        target="_blank"><?php echo $profileData->website; ?></a>
                                                </div>
                                            </li>
                                            <?php } ?>
