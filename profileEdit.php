							...
							<li class="hover"><label class="drop-label" for="drop-wrap1"><img src="<?php echo $user->profileImage; ?>" /></label>
								...
								<div class="drop-wrap">
									<div class="drop-inner">
										<ul>
											<li><a href="<?php echo $user->username; ?>"><?php echo $user->username; ?></a></li>
											<li><a href="settings/account">Cài đặt</a></li>
											<li><a href="includes/logout.php">Đăng xuất</a></li>
										</ul>
									</div>
								</div>
=======
...
<<<<<<< HEAD
					...
					<div class="edit-button">
						<span>
							<button class="f-btn" type="button" onclick="window.location.href='<?php echo BASE_URL . $user->username; ?>'" value="Cancel">Huỷ</button>
						</span>
						<span>
							<input type="submit" id="save" value="Lưu thay đổi">
						</span>
									...
									<div class="profile-extra-info">
										<div class="profile-extra-inner">
											<ul>
												<li>
													<div class="profile-ex-location">
														<input id="cn" type="text" name="country" placeholder="Đến từ" value="<?php echo $user->country; ?>" />
													</div>
												</li>
												<li>
													<div class="profile-ex-location">
...
<<<<<<< HEAD
<<<<<<< HEAD
										<span><i class="fa fa-retweet" aria-hidden="true"></i></span><span>' . $user->screenName . '. Đăng lại</span>
=======
							...
							<div class="t-s-f-right">
								<ul> 
									...
									<li>
										...
										<ul> 
										  <li><label class="deleteTweet" data-tweet="'.$tweet->tweetID.'">Xoá Tweet</label></li>
										</ul>
									</li>' : '').'
