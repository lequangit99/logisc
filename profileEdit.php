                    ...
                    <div class="nav-left">
                        <ul>
                            ...
                            <li><a href="<?php echo BASE_URL;?>i/notifications"><i class="fa fa-bell"
                                        aria-hidden="true"></i>Notifications<span id="notificaiton"></span></a></li>
                            ...
                            <li class="hover"><label class="drop-label" for="drop-wrap1"><img
                                ...
                                <div class="drop-wrap">
                                    <div class="drop-inner">
                                        <ul>
                                            <li><a
                                                    href="<?php echo $user->username;?>"><?php echo $user->username;?></a>
                                            </li>
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <ul>
                                        <li>
                                            ...
                                            <input type="file" onchange="this.form.submit();" name="profileCover"
                                                id="file-up" />
                                        </li>
                                        <li>
                                            <label for="cover-upload-btn">
                    ...
                    <div class="edit-button">
                        <span>
                            <button class="f-btn" type="button"
                                onclick="window.location.href='<?php echo BASE_URL.$user->username;?>'"
                                                    ...
                                                    <ul>
                                                        <li>
                                                            ...
                                                            <input id="profileImage" type="file"
                                                                onchange="this.form.submit();" name="profileImage" />
                                ...
                                <form id="editForm" method="post" enctype="multipart/Form-data">
                                    ...
                                    <div class="profile-name-wrap">
                                        <div class="profile-name">
                                            <input type="text" name="screenName"
                                                value="<?php echo $user->screenName;?>" />
                                        </div>
                                    ...
                                    <div class="profile-extra-info">
                                        <div class="profile-extra-inner">
                                            <ul>
                                                <li>
                                                    <sdiv class="profile-ex-location">
