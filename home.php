...
<div class="nav-container">
	...
	<div class="nav">
		...
		<div class="nav-left">
			<ul>
				<li><a href="<?php echo BASE_URL; ?>home.php"><i class="fa fa-home" aria-hidden="true"></i>Trang chủ</a></li>
								...
								<div class="tweet-inner">
									...
									<div class="tweet-body">
										<form method="post" enctype="multipart/form-data">
											<textarea class="status" maxlength="141" name="status" placeholder="Bạn đang nghĩ gì?" rows="4" cols="50"></textarea>
											<div class="hash-box">
												<ul>
												</ul>
											</div>
